import { DeclarationReflection, ProjectReflection, Reflection } from "../../../../models";
import { JSX } from "../../../../utils";
import type { PageEvent } from "../../../events";
import { camelToTitleCase, classNames, getDisplayName, wbr } from "../../lib";
import type { DefaultThemeRenderContext } from "../DefaultThemeRenderContext";
import { NavigationElement, getNavigationElements } from "../utils";
...
// If you change this, be aware that it is dynamically updated by the navigation component in the theme js
// using data generated by the AssetsPlugin.
export function navigation(context: DefaultThemeRenderContext, props: PageEvent<Reflection>) {
    ...
    return (
        <nav class="tsd-navigation" data-navigation-update>
    ...
    function links(mod: NavigationElement, parents: string[]) {
        ...
        if (!children.length || (mod instanceof Reflection && !inPath(mod))) {
        ...
        return (
            <details
                ...
                open={mod instanceof Reflection}
